...
Usage() {
    echo ""
    echo "Usage: `basename $0` <T1-head> <T1-brain> <out> <fnirt-affine-init|\"none\"> [<affine-cost> <flirt-affine-init>] <MNI-template-head> <MNI-template-brain> <MNI-brainmask> <subj_idx> <sess_idx>"
    echo ""
    exit 1
}
